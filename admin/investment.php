		...
		<div class="main-container">
			<div class="top-head-txt">
						<div>
							...
							<lable class="sub-heading">Add new Investment Opportunity from here</lable></p>
						</div>
						<div class="toggle">
			...
			<div class="input-holder">
				<section>
					<form action="../backend/post/add_post.php" method="POST"  enctype="multipart/form-data">
						...
						<div>
							<input type="text" name="collateral" class="input" placeholder="Enter Investment Collateral" 
							onchange="updatetxtlive(this)"required="true">			
						</div>
						<div>
